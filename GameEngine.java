...
public class GameEngine extends Time implements KeyListener, GameReporter{
	GamePanel gp;
	...
	private void process(){
		if(getCount()%20 == 0){  //hard level when Over time 30 sec
			difficulty += 0.01;
		}
	...
	public void die(){
		timer.stop();
		JOptionPane.showMessageDialog(null, "MY SCORE IS "+ getScore());
     }
